...
import { useToast, type ToastMessageData, type ToastType } from '~/context/ToastContext'; // Import from context
...
const ToastMessage: React.FC<ToastMessageProps> = ({ toast, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Optional: Add a progress bar or timer indicator here */}
...
// Export the container as the default or primary export for simplicity
